...
>(({ className, children, container, ...props }, ref) => {
  ...
  const describedBy = (props as any)["aria-describedby"] ?? autoDescId;
  ...
  return (
    <DialogPortal container={container}>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={describedBy as any}
        className={cn(
        ...
        {...props}
      >
        {/* Hidden default description to satisfy Radix a11y without affecting UI */}
        <span id={autoDescId} className="sr-only">Dialog window</span>
        {children}
