    ...
    <section className="relative pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed mb-6 sm:mb-8 px-2">
          Real-world validation of the <span className="text-genie-accent font-semibold">Experiment → Validate → Lead to Deploy</span> framework through healthcare AI implementations. <strong>2 live features launched:</strong> GenieAI Experimentation Hub platform and Genie Conversational AI with 80+ knowledge contexts, plus <strong>10+ experiments across pipeline</strong>.
        </p>
